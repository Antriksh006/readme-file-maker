...
g = Github()
repo = g.get_repo("aryancodes1/NYDHackathonRAG")
...
def get_bot_response_readme(text, groq_client):
    ...
    Format the README with proper Markdown syntax including headers, code blocks, lists, etc. Make it professional, complete, and easy to understand for developers of any level. Add several emojis and proper formatting of text to make it more visuallu appealing, like adding bold text, italics, headers, etc. Make sure the read me file is visually appealing and easy to read. I am providing you with some syntax examples of markdown language, make sure you use them to make more visually aesthetic. Here it is {basic_markdown}. This is what a demo readme file looks like, you can use this as a reference: {demo_readme}, make sure you stay very close to this.Components like this [![Next.js](https://img.shields.io/badge/Built%20with-Next.js-black?style=for-the-badge&logo=next.js)](https://nextjs.org/)
